...
//TODO remove vdisk_path
char *vdisk_path = "/root/newdisk";
char *root_path = "/";
...
static struct fuse_operations u_operation = { .getattr = ufs_getattr, .open =
ufs_open, .readdir = ufs_readdir, .mkdir = ufs_mkdir,
        .rmdir = ufs_rmdir, .mknod = ufs_mknod, .write = ufs_write, .read =
        ufs_read, .unlink = ufs_unlink, .truncate = ufs_truncate,
        .flush = ufs_flush, .init = u_fs_init };
